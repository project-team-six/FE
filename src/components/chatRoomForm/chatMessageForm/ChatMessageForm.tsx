						...
						return (
							<S.Li key={index}>
								{isSend ? (
									<S.SendBox>
										{/* 발신 */}
										<S.SpanBox $backgroundColor='4FBE9F' borderRadius='15px 0 15px 15px'>
											{isImage ? (
												<S.Img src={msg.imageUrl} alt='imageUrl' />
											) : (
												<S.Span fontSize={13} fontWeight='500' color='FFFFFF'>
													{msg.message}
												</S.Span>
											)}
										</S.SpanBox>
											...
											<S.MsgInfoBox>
												<S.SpanBox $backgroundColor='F1F1F1' borderRadius='0 15px 15px 15px'>
													{isImage ? (
														...
														<S.Span fontSize={13} fontWeight='500' color='616161'>
															{msg.message}
														</S.Span>
													)}
												</S.SpanBox>
												<S.TimeBox>
													<S.Span fontSize={9} fontWeight='400'>
														{time}
													</S.Span>
												</S.TimeBox>
											</S.MsgInfoBox>
