		...
		<LayoutBox>
			<St.FooterLayout>
				<St.SummarySection>
					...
					<p>
						Welcome to Sobun Sobun. We are a small community for single-person households. This website is
						created through a collaboration between three front-end developers, four back-end developers,
						and one designer. Thank you for showing interest.
					</p>
				</St.SummarySection>
				<St.DetailSection>
			...
			<FlexBox style={{ paddingTop: "10px", fontSize: "11px" }}>
