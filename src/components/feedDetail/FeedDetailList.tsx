...
const FeedDetailList: React.FC<FeedDetailProps> = ({ closed, onClose }) => {
	...
	const { data: detailFeed, isLoading } = useQuery(["detailFeed", postId], () => getListFeed(postId), {
		staleTime: 1000 * 60 * 3,
	});
				...
				<FDSt.DetailMain>
					<FDSt.DetailTitle>
						...
						{userId === authId ? (
							...
							<FDSt.NotAuth>
								...
								<button>
									<img src={require(`../../asstes/pin.png`)} alt='관심글 등록 아이콘' />
								</button>
								<button>
					...
					<FDSt.DetailList>
						...
						<div>
							...
							<p>
								거래가능날짜 :{detailFeed.transactionStartDate} -{detailFeed.transactionEndDate}
							</p>
							<p>
