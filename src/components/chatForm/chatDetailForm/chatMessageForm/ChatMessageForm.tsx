...
const ChatMessageForm = ({
	...
	return (
		<ul>
			{roomData &&
				messages &&
				messages.map((m: chatRoomMessageType) => {
					const profile = m.profileImageUrl === "nonImage" ? profileImg : m.profileImageUrl; // 발신자 프로필 이미지 URL
					...
					return (
						<div>
							{!isEnter ? (
								<div>
									{isSend ? (
											...
											<S.SendBox>
												<S.MessageBox
													...
													{isImage ? (
														...
														<S.Span fontSize={13} fontWeight='400' color='616161'>
															{m.message}
														</S.Span>
													)}
												</S.MessageBox>
										...
										<S.Li>
											...
											<div>
												<S.Span fontSize={14} fontWeight='700'>
													{m.sender}
												</S.Span>
												<S.ReceiveBox>
													<S.MessageBox
													...
													<S.TimeBox>
														<S.Span fontSize={9} fontWeight='400' color='959595'>
															{time}
														</S.Span>
													</S.TimeBox>
												</S.ReceiveBox>
								...
								<S.NotificationLi>
									<S.Span fontSize={11} fontWeight='400' color='8B8B8B'>
