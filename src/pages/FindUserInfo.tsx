...
const FindUserInfo = () => {
    ...
    return (
        <div>
            <section>
                <label>아이디</label>
                <input type="text" required value={username} onChange={changeUsername} placeholder="이름을 입력해주세요."/>
                <input type="text" required value={phoneNumber} onChange={changePhoneNumber} placeholder="전화번호를 입력해주세요."/>
