...
const SignUp: React.FC = () => {
    ...
    return (
        <div>
            <section>
                <InputForm label="이메일" type="text" inputVal={email} setInputVal={setEmail} setIsVal={setIsEmail} pattern={emailPattern}/>
                <InputForm label="이름" type="text" inputVal={username} setInputVal={setUsername} setIsVal={setIsUsername} pattern={usernamePattern}/>
                <InputForm label="닉네임" type="text" inputVal={nickname} setInputVal={setNickname} setIsVal={setIsNickname} pattern={nicknamePattern}/>
                <InputForm label="전화번호" type="number" inputVal={phoneNumber} setInputVal={setPhoneNumber} setIsVal={setIsPhoneNumber} pattern={phoneNumberPattern}/>
                <InputForm label="비밀번호" type="password" inputVal={password} setInputVal={setPassword} setIsVal={setIsPassword} pattern={passwordPattern}/>
                <form>
                    <label>비밀번호 확인</label>
                    <input type="password" required placeholder="비밀번호를 입력해주세요." value={matchPin} onChange={handleChangeMatchPin}/>
